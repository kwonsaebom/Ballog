...
const MyPageScreen = () => {
  ...
  const onDayPress = (day) => {
    ...
    const isRedDate = markedDates[selectedDate] && markedDates[selectedDate].selectedColor === '#E8A5B0';
    if (isRedDate) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.SettingImageButton} onPress={onPressHandler}>
      ...
      <View style={styles.ScoreContainer}>
        ...
        <View style={styles.Score}>
          <Image style={styles.ScoreImage} source={{ uri: data?.opposition_icon_flag }}>{/* user_team_icon_flag로 수정 필요, 데이터 부족 */}</Image> 
            {data && data.user_team_score !== null && data.opposition_score !== null ? (
          ...
          <Image style={styles.ScoreImage} source={{ uri: data?.opposition_icon_flag }}></Image>
        </View>
      </View>
